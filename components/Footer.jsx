...
export default function Footer() {
  ...
  return (
    <footer className="glass-effect border-t border-white/10 section-padding">
      <div className="container-custom">
        ...
        <div className="text-center text-gray-500 text-sm mt-8 pt-8 border-t border-white/10">
