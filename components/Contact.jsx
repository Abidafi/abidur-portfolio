          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="space-y-3">
                <p className="flex items-center gap-3"><span>📍</span><span className="text-gray-600">{personal.location}</span></p>
            ...
            <div>
              <form className="space-y-4">
                ...
                <textarea placeholder="Your Message" rows={4} className="input-style resize-none"></textarea>
