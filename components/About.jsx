      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 gap-12">
          <motion.div initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }}>
            <h3 className="text-2xl font-bold mb-4">Engineering Digital Experiences</h3>
            <p className="text-gray-400 leading-relaxed mb-6">{personal.bio}</p>
            <div className="grid grid-cols-2 gap-4">
              <div className="glass-effect rounded-xl p-4">
                <div className="text-[#6C63FF] font-bold">React & Next.js</div>
                <div className="text-sm text-gray-400">Frontend Specialist</div>
              </div>
              <div className="glass-effect rounded-xl p-4">
              ...
              <div className="glass-effect rounded-xl p-4">
                ...
                <div className="text-sm text-gray-400">3D & Immersive</div>
              </div>
              <div className="glass-effect rounded-xl p-4">
                <div className="text-[#6C63FF] font-bold">DevOps</div>
                <div className="text-sm text-gray-400">Cloud & CI/CD</div>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.5 }} className="glass-effect rounded-2xl p-6">
            <h4 className="text-xl font-bold mb-4">Core Technology Expertise</h4>
            <div className="space-y-4">
              <div>
                <h5 className="text-[#6C63FF] font-medium mb-2">Frontend</h5>
                <div className="flex flex-wrap gap-2">
                  {skills.frontend.map((skill) => (
                    <span key={skill} className="glass-effect px-3 py-1 rounded-full text-sm">{skill}</span>
                  ))}
                </div>
              </div>
              <div>
